...
public class CreateNewUser {
	...
	static String url = "https://opensource-demo.orangehrmlive.com/index.php/auth/login"; // Orange HRM app login page
																							// url
...
//	@Parameters({ "e_name", "u_name", "u_pwd" })
	@Test(dataProvider = "createNewUser", dataProviderClass = TestDataProvider.class)
	public void getRole(String r_type, String e_name, String u_name, String e_status, String e_pwd, String e_c_pwd)
			throws InterruptedException {
// method parameters counts should be same with the test file column count
		String role_type = r_type;
		String employeeName = e_name;
		String userName = u_name;
		String status = e_status;
		String pwd_value = e_pwd;
		String pwd_value2 = e_c_pwd;
...
//		ReUsableMethods rs = new ReUsableMethods();
		...
		selectRole.selectByVisibleText(role_type);
		...
		// enter confirm pwd
		driver.findElement(By.id("systemUser_confirmPassword")).sendKeys(pwd_value2);
		Thread.sleep(5000);
		// click submit
