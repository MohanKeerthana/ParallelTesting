...
public class DemoCreateNewUser {
	...
	@Test
	public void getRole(String v1, String v2, String v3) throws InterruptedException {
		...
		rs.selectListItem(selectStatus, "Enabled");
		// enter pwd		
